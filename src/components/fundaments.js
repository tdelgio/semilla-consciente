  ...
  return (
    <div className="max-w-6xl my-10 mx-auto">
      ...
      <div className="w-full mx-auto">
        <div className="relative w-full lg:max-w-4xl bg-blue-lagoon text-white sm:text-center sm:px-16 lg:text-left px-3 pt-28 pb-16 lg:w-3/4 lg:min-h-1/2 lg:ml-auto lg:rounded-3xl lg:pl-64 lg:m-4 lg:max-w-4xl">
