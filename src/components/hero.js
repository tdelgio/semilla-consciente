            ...
            <div>
              ...
              <main className="mt-10 max-w-8xl px-4 sm:mt-12 sm:px-6 md:mt-16 md:w-screen lg:-mt-16 lg:h-screen lg:flex lg:flex-col justify-center lg:px-8 ">
                <div className="sm:text-center lg:text-left">
                  <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl 2xl:text-7xl">
                    <span className="block xl:inline">Somos</span>

                    <span className="block text-blue-lagoon ">
                      Semilla Consciente.
                    </span>
                  </h1>
                  <p className="mt-3 text-base text-winter-gray sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  ...
                  <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                    ...
                    <div className="mt-3 sm:mt-0 sm:ml-3">
                      <a
                        href="#"
                        className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base  rounded-md text-blue-lagoon bg-white hover:bg-vanilla md:py-4 md:text-lg md:px-10 shadow-md"
                      >
                        Asociate
                      </a>
                    </div>
